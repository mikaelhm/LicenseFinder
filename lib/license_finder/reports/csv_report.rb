...
module LicenseFinder
  class CsvReport < Report
    COMMA_SEP =  ","
    AVAILABLE_COLUMNS = %w[name version authors licenses license_files approved summary description homepage install_path package_manager groups]
    ...
    def format_license_files(dep)
      dep.license_files.join(self.class::COMMA_SEP)
    end
